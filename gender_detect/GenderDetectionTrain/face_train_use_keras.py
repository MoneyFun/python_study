...
class Dataset:
    ...
    def load(self, img_rows=IMAGE_SIZE, img_cols=IMAGE_SIZE,img_channels=3, 
        ...
        train_images, train_labels = load_dataset("genderdetectionfacedata/train")
        test_images, test_labels = load_dataset("genderdetectionfacedata/test")
        valid_images, valid_labels = load_dataset("genderdetectionfacedata/valid")
...
class Model:
    ...
    def train(self, dataset, batch_size=20, nb_epoch=10, data_augmentation=True):
        ...
        # 不使用Data Augmentation，所谓的Data Augmentation就是从我们提供的训练数据中利用旋转、翻转、加噪声等方法创造新的训练数据，有意识的提升训练数据规模，增加模型训练量
...
if __name__ == '__main__':
    ...
    model.train(dataset)
    model.save_model(file_path = '../model/gender.model.h5')
